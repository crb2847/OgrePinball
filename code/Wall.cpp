...
Wall::Wall(Game *game, int x, Ogre::Vector3 scale,
	...
	myName = "GroundEntity" + Ogre::StringConverter::toString(x);
	Ogre::Entity* entGround = scnMgr->createEntity(myName, "ground");
	...
	rigidBody = new OgreBulletDynamics::RigidBody("bt"+myName, mWorld);
